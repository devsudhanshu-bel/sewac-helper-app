      ...
      children: [
        ...
        Theme(
          data: Theme.of(context).copyWith(
            canvasColor: Colors.white, // Ensures the menu background is white
          ),
          child: DropdownButtonHideUnderline(
            child: ButtonTheme(
              alignedDropdown: true, // Helps align the menu text with the button text
              child: DropdownButtonFormField<String>(
                value: value,
                isExpanded: true,
                menuMaxHeight: 250,
                // Forces the dropdown to open below the widget
                  ...
                  return DropdownMenuItem<String>(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(item, style: const TextStyle(fontSize: 14, color: Color(0xFF2C3E50))),
                      ],
                    ),
                  );
                }).toList(),
